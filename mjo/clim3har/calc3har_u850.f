...
c Input file
      open(11,file=dir1//'u850.mjo.daily.climatology.1979-2001.bin',
...
c Output files
      ...
      open(20,file=dir1//'u850.clim.mean.1979-2001.bin',
     #        access='direct',recl=rl1,status='replace')
      open(21,file=dir1//'u850.clim.aa.1979-2001.bin',
     #        access='direct',recl=rl2,status='replace')
      open(22,file=dir1//'u850.clim.bb.1979-2001.bin',
