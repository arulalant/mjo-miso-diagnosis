...
c 3 seperate bin files.
      ...
      character*(*) dir1
      parameter(dir1='/gpfs4/home/arulalan/MJO/climatology/Daily/olr/')

c Input file
      open(11,file=dir1//'olr.mjo.daily.climatology.1979-2001.bin',
...
c Output files
      ...
      open(20,file=dir1//'olr.clim.mean.1979-2001.bin',
     #        access='direct',recl=rl1,status='replace')
      open(21,file=dir1//'olr.clim.aa.1979-2001.bin',
     #        access='direct',recl=rl2,status='replace')
      open(22,file=dir1//'olr.clim.bb.1979-2001.bin',
